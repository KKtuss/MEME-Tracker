...
class MemeTrackerAppOpenCV:
    def __init__(self, root):
        self.root = root
        self.root.title("Meme Tracker - OpenCV Camera Pose Detection")
        self.root.geometry("1200x800")
        
        # Initialize tracker
        self.tracker = CameraTrackerOpenCV()
    ...
    def create_widgets(self):
        ...
        self.info_label = ttk.Label(control_frame, text="Detection: Face detection, smile detection, hand tracking", 
                                   font=("Arial", 10))
