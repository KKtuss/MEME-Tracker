...
import time
import os
from camera_tracker_dl import CameraTrackerDL

class MemeTrackerAppDL:
    def __init__(self, root):
        self.root = root
        self.root.title("Meme Tracker - Deep Learning Camera Pose Detection")
        self.root.geometry("1200x800")
        
        # Initialize tracker
        self.tracker = CameraTrackerDL()
    ...
    def create_widgets(self):
        ...
        self.info_label = ttk.Label(control_frame, text="Detection: Deep Learning CNN for smile detection", 
                                   font=("Arial", 10))
