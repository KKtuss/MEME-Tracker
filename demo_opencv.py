#!/usr/bin/env python3
"""
Demo script showing how to use the CameraTrackerOpenCV programmatically
without the GUI.
"""
...
def demo_basic_detection():
    ...
    try:
        while True:
            ...
            # Display frame
            cv2.imshow('Meme Tracker Demo (OpenCV)', frame)
...
def demo_with_image_assignment():
    ...
    print("  py main_app_opencv.py")

def main():
    """Main demo function"""
    print("=" * 60)
    print("MEME TRACKER OPENCV DEMO")
    print("=" * 60)
    print()
    print("Choose a demo:")
