...
import time
import os
from camera_tracker_working import CameraTrackerWorking

class MemeTrackerAppWorking:
    def __init__(self, root):
        self.root = root
        self.root.title("Meme Tracker - Working Smile Detection")
        self.root.geometry("1200x800")
        
        # Initialize tracker
        self.tracker = CameraTrackerWorking()
    ...
    def create_widgets(self):
        ...
        self.info_label = ttk.Label(control_frame, text="Detection: Brightness + Edge detection for smiles", 
                                   font=("Arial", 10))
...
def main():
    ...
    root = tk.Tk()
    app = MemeTrackerAppWorking(root)
