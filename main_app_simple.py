...
import time
import os
from camera_tracker_simple import CameraTrackerSimple

class MemeTrackerAppSimple:
    def __init__(self, root):
        self.root = root
        self.root.title("Meme Tracker - Smart Smile Detection")
        self.root.geometry("1200x800")
        
        # Initialize tracker
        self.tracker = CameraTrackerSimple()
    ...
    def create_widgets(self):
        ...
        self.info_label = ttk.Label(control_frame, text="Detection: Smart mouth shape analysis", 
                                   font=("Arial", 10))
