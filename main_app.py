...
class MemeTrackerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Meme Tracker - Camera Pose Detection")
    ...
    def create_pose_config_widgets(self, parent):
        ...
        pose_categories = {
            "Smile Poses": ["smile_left_hand", "smile_right_hand", "smile_both_hands", "smile_no_hands"],
            "Neutral Poses": ["neutral_left_hand", "neutral_right_hand", "neutral_both_hands"],
            "Eye Direction": ["look_left", "look_right", "look_center"]
        }
